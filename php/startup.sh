...
mysql -h localhost -uroot -ptest mysql -e "SET PASSWORD FOR 'root'@'localhost' = PASSWORD('root');"
...
mysql -h localhost -uroot -proot -e "GRANT ALL ON *.* to root@'%' IDENTIFIED BY 'root';"
mysql -h localhost -uroot -proot mysql -e "FLUSH PRIVILEGES;"
